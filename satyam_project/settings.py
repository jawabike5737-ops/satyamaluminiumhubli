...
# SECURITY
# ========================
# Robust boolean parsing (case-insensitive): DEBUG=True / true / TRUE / 1 all work.
...
# Trust Render's proxy so request.is_secure() correctly returns True
SECURE_PROXY_SSL_HEADER = ("HTTP_X_FORWARDED_PROTO", "https")

# Cookie / transport security (required for CSRF/session cookies to behave
# correctly behind Render's HTTPS-terminating proxy)
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            "context_processors": [
                ...
                # Add RAM usage globally for the admin-style status widget
                "core.context_processors.ram_usage",
            ],
        },
    },
]
